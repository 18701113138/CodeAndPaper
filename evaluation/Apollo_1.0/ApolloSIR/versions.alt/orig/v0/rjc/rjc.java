...
public class rjc {
	...
	public void MainSymbolic(double in1_0, double in1_1, double in1_2, double in2_0, double in2_1, double in2_2, double[] out1, double[] out2) {
		...
		double iDiscovery_PreVariable_71=this.Reaction_Jet_Control_100000006_class_member0.NumeratorTerms_5557;
		...
		assert(daikon.Quant.eltsNotEqual(this.Reaction_Jet_Control_100000006_class_member0.NumeratorCoefficients_3554, 0));
		...
		assert(daikon.Quant.memberOf(iDiscovery_PreVariable_71 , out1 ));
		...
		assert(daikon.Quant.eltsEqual(out2, iDiscovery_PreVariable_71));
		...
		assert(daikon.Quant.memberOf(iDiscovery_PreVariable_71 , out2 ));
		...
		assert(daikon.Quant.eltsGTE(this.Reaction_Jet_Control_100000006_class_member0.DenominatorCoefficients_4556, iDiscovery_PreVariable_71));

		assert(daikon.Quant.memberOf(iDiscovery_PreVariable_71 , this.Reaction_Jet_Control_100000006_class_member0.DenominatorCoefficients_4556 ));
		...
		assert(daikon.Quant.fuzzy.eq(0, 5.998892770126005E15 * this.Reaction_Jet_Control_100000006_class_member0.DenominatorTerms_14618 - 5.998892770126005E15 * iDiscovery_PreVariable_12 + 4));
		...
		assert(daikon.Quant.fuzzy.eq(this.Reaction_Jet_Control_100000006_class_member0.Yaw_Control_Law_100000076_class_member15.Value793, 2.0));
		assert(daikon.Quant.eltsEqual(out1, iDiscovery_PreVariable_71));
		assert(daikon.Quant.eltsLT(this.Reaction_Jet_Control_100000006_class_member0.DenominatorCoefficients_4556, this.Reaction_Jet_Control_100000006_class_member0.Yaw_Control_Law_100000076_class_member15.Value793));
